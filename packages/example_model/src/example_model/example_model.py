...
def Binom_BP_Model(model_inputs: dict[str, Any]) -> list[int]:
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Run Binom_BP_Model with parameters from JSON file"
    )
    parser.add_argument(
    ...
    result = Binom_BP_Model(input_params)
